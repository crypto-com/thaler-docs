...
Copy the generated genesis configuration prepared in [Section 6](https://github.com/crypto-com/chain#62-generate-genesis) and add it to `~/.tendermint/config/genesis.json` such that the file looks similar to this:
```diff
{
